...
export function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden md:h-[calc(100svh-4.5rem)]">
      ...
      <div
        className="pointer-events-none absolute inset-0 z-10 lg:bg-gradient-to-b lg:from-white/94 lg:via-white/14 lg:to-white/4 dark:lg:from-black/62 dark:lg:via-black/24 dark:lg:to-transparent"
        aria-hidden
      />
