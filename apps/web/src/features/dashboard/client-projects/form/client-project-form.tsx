...
export function ClientProjectForm({
  ...
  const formId = "client-project-form";
  const pageTitle =
    mode === "create"
  ...
  return (
    <DashboardDetailShell
      ...
      title={pageTitle}
      formId={formId}
      onBack={() => navigate({ to: "/dashboard/client-projects" })}
          ...
          {(field) => (
            <Field>
              ...
              <AsyncSearchableSelect
                ...
                error={partnerSelect.isError ? "Failed to load clients" : null}
                disabled={isLoading || isReadOnly}
              />
            </Field>
          )}
          ...
          {(field) => (
            <Field>
              ...
              <AsyncSearchableSelect
                ...
                error={serviceSelect.isError ? "Failed to load services" : null}
                disabled={isLoading || isReadOnly}
              />
            </Field>
          )}
